 ...
 * @version 2.1.1 2006-07-20 Minimal size threshold was enforced too eagerly.
...
public class CreationTool extends AbstractTool {
  ...
  public void mouseDragged(MouseEvent evt) {
    if (createdFigure != null) {
      ...
      createdFigure.willChange();
      createdFigure.basicSetBounds(constrainPoint(new Point(anchor.x, anchor.y)), p);
      createdFigure.changed();
    }
  }
  ...
  public void mouseReleased(MouseEvent evt) {
    if (createdFigure != null) {
      ...
      if (bounds.width == 0 && bounds.height == 0) {
        ...
        if (Math.abs(anchor.x - evt.getX()) < minimalSizeThreshold.width && Math.abs(anchor.y - evt.getY()) < minimalSizeThreshold.height) {
