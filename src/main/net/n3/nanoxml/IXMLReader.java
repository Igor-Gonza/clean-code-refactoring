...
public interface IXMLReader {
  ...
  /**
   * Opens a stream from a  and system ID.
   *
   * @param ID the  ID, which may be null.
   ...
   * @throws java.io.FileNotFoundException  If the system ID refers to a local file which does not exist.
   * @throws java.io.IOException            If an error occurred opening the stream.
   */
   Reader openStream(String ID, String systemID) throws MalformedURLException, FileNotFoundException, IOException;
  ...
  /**
   * Sets the  ID of the current stream.
   *
   * @param ID the  ID.
   */
