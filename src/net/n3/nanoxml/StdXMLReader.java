...
public class StdXMLReader implements IXMLReader {
   ...
   * @version $Name: RELEASE_2_2_1 $, $Revision: 1.4 $
   */
  private static class StackedReader {
  ...
  /**
   * Scans the encoding from a &lt;?xml...?&gt; tag.
   *
   ...
   */
  public Reader openStream(String publicID, String systemID) throws MalformedURLException, IOException {
