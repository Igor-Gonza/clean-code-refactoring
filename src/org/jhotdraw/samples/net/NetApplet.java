      ...
      public Object construct() {
        ...
        try {
          ...
          if (getParameter("data") != null) {
            NanoXMLLiteDOMInput domInput = new NanoXMLLiteDOMInput(new NetFactory(), new StringReader(getParameter("data")));
            ...
            try {
              ...
              NanoXMLLiteDOMInput domInput = new NanoXMLLiteDOMInput(new NetFactory(), in);
              result = domInput.readObject(0);
            } finally {
              if (in != null) in.close();
            }
