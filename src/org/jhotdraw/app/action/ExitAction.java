...
public class ExitAction extends AbstractApplicationAction {
    ...
    if (app.isEnabled()) {
      ...
      switch (unsavedProjectsCount) {
        ...
        case 1: {
          ...
          JSheet.showSheet(pane, unsavedProject.getComponent(), evt1 -> {
            Object value = evt1.getValue();
        ...
        default: {
          JOptionPane pane = new JOptionPane("<html>" + UIManager.get("OptionPane.css") + "<b>You have " + unsavedProjectsCount + " documents with unsaved changes. " + "Do you want to " + "review these changes before quitting?</b><p>" + "If you don't review your documents, " + "all your changes will be lost.", JOptionPane.QUESTION_MESSAGE);
  ...
  protected void saveChanges() {
    if (unsavedProject.getFile() == null) {
      ...
      JSheet.showSaveSheet(fileChooser, unsavedProject.getComponent(), evt -> {
  ...
  protected void reviewChanges() {
    if (unsavedProject.isEnabled()) {
      ...
      pane.setInitialValue(options[0]);
      pane.putClientProperty("Quaqua.OptionPane.destructiveOption", 2);
      JSheet.showSheet(pane, unsavedProject.getComponent(), evt -> {
  ...
  protected void fileSaved(Project unsavedProject, File file, Object value) {
    if (value == null) {
      ...
      JSheet.showMessageSheet(unsavedProject.getComponent(), "<html>" + UIManager.getString("OptionPane.css") + "<b>Couldn't save to the file \"" + file + "\".<p>" + "Reason: " + value, JOptionPane.ERROR_MESSAGE);
    }
    unsavedProject.setEnabled(true);
    if (oldFocusOwner != null) {
      oldFocusOwner.requestFocus();
