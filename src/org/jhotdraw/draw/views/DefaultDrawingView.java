...
public class DefaultDrawingView extends JComponent implements DrawingView, DrawingListener, HandleListener, EditableComponent {
  ...
  public void setEmptyDrawingMessage(String newValue) {
    ...
    if (newValue == null) {
      ...
      emptyDrawingLabel.setHorizontalAlignment(SwingConstants.CENTER);
    }
  ...
  private void validateHandles() {
    if (!handlesAreValid) {
      ...
      } while (level-- > 0 && selectionHandles.isEmpty());
      detailLevel = level + 1;
    ...
    if (listenerList.getListenerCount() > 0) {
      ...
      for (int i = listeners.length - 2; i >= 0; i -= 2) {
        if (listeners[i] == FigureSelectionListener.class) {
          ...
          if (event == null) event = new FigureSelectionEvent(this);
  ...
  public void copy() {
    ...
    try {
      ...
      logger.info("DefaultDrawingView - copy: " + e.getMessage());
      getToolkit().beep();
    }
  }
  ...
  public void paste() {
    ...
    try {
      ...
      if (transfer.isDataFlavorSupported(flavor)) {
        ...
        try (InputStream in = (InputStream) transfer.getTransferData(flavor)) {
      ...
      logger.info("DefaultDrawingView - paste: " + e.getMessage());
    }
  }
