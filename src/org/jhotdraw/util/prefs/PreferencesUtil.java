...
public class PreferencesUtil {
   ...
   * On first run, sets the window to its preferred size in the top left
   ...
   * On first run, sets the palette to its preferred location in the top left
   * corner of the screen.
...
//      }
   ...
   * On first run, sets the frame to its preferred size in the top left
